...
export class ProjectCapabilityHostsImpl {
    client;
    /**
     ...
     */
    async beginDelete(resourceGroupName, accountName, projectName, capabilityHostName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, accountName, projectName, capabilityHostName, options) {
        const poller = await this.beginDelete(resourceGroupName, accountName, projectName, capabilityHostName, options);
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, accountName, projectName, capabilityHostName, options) {
