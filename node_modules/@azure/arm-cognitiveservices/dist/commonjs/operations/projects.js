...
class ProjectsImpl {
     ...
     * @param options The options parameters.
     */
    async beginCreate(resourceGroupName, accountName, projectName, project, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateAndWait(resourceGroupName, accountName, projectName, project, options) {
        const poller = await this.beginCreate(resourceGroupName, accountName, projectName, project, options);
     ...
     * @param options The options parameters.
     */
    async beginUpdate(resourceGroupName, accountName, projectName, project, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateAndWait(resourceGroupName, accountName, projectName, project, options) {
        const poller = await this.beginUpdate(resourceGroupName, accountName, projectName, project, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, accountName, projectName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, accountName, projectName, options) {
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, accountName, projectName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, projectName, options }, getOperationSpec);
    }
    /**
     * Returns all the projects in a Cognitive Services account.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
...
exports.ProjectsImpl = ProjectsImpl;
