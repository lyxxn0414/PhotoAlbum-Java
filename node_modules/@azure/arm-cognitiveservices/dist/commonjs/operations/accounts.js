...
class AccountsImpl {
    ...
    async *listModelsPagingPage(resourceGroupName, accountName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
        ...
        while (continuationToken) {
            result = await this._listModelsNext(resourceGroupName, accountName, continuationToken, options);
            continuationToken = result.nextLink;
            let page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listModelsPagingAll(resourceGroupName, accountName, options) {
