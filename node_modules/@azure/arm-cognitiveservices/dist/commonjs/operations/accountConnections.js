...
exports.AccountConnectionsImpl = void 0;
...
class AccountConnectionsImpl {
    client;
    /**
     * Initialize a new instance of the class AccountConnections class.
     ...
     * @param options The options parameters.
     */
    delete(resourceGroupName, accountName, connectionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, connectionName, options }, deleteOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, accountName, connectionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, connectionName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    update(resourceGroupName, accountName, connectionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, connectionName, options }, updateOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    create(resourceGroupName, accountName, connectionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, connectionName, options }, createOperationSpec);
    }
    /**
     * Lists all the available  Cognitive Services account connections under the specified account.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
...
exports.AccountConnectionsImpl = AccountConnectionsImpl;
...
//# sourceMappingURL=accountConnections.js.map