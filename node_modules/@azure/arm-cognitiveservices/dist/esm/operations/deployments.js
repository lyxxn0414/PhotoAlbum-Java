...
export class DeploymentsImpl {
    ...
    async *listSkusPagingPage(resourceGroupName, accountName, deploymentName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
        ...
        while (continuationToken) {
            result = await this._listSkusNext(resourceGroupName, accountName, deploymentName, continuationToken, options);
            continuationToken = result.nextLink;
            let page = result.value || [];
            setContinuationToken(page, continuationToken);
            yield page;
    ...
    async *listSkusPagingAll(resourceGroupName, accountName, deploymentName, options) {
        for await (const page of this.listSkusPagingPage(resourceGroupName, accountName, deploymentName, options)) {
            yield* page;
        }
    }
    /**
