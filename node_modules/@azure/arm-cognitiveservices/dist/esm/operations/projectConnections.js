...
export class ProjectConnectionsImpl {
    client;
    /**
     ...
     */
    list(resourceGroupName, accountName, projectName, options) {
     ...
     * @param options The options parameters.
     */
    delete(resourceGroupName, accountName, projectName, connectionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, projectName, connectionName, options }, deleteOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, accountName, projectName, connectionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, projectName, connectionName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    update(resourceGroupName, accountName, projectName, connectionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, projectName, connectionName, options }, updateOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    create(resourceGroupName, accountName, projectName, connectionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, projectName, connectionName, options }, createOperationSpec);
    }
    /**
     * Lists all the available Cognitive Services project connections under the specified project.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     ...
     * @param options The options parameters.
     */
    _list(resourceGroupName, accountName, projectName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, accountName, projectName, options }, listOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     ...
     * @param options The options parameters.
     */
    _listNext(resourceGroupName, accountName, projectName, nextLink, options) {
