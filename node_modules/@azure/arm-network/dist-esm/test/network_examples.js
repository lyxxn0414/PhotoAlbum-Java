...
describe("Network test", () => {
    ...
    it("virtualNetworks list test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resArray = new Array();
            try {
                for (var _d = true, _e = __asyncValues(client.virtualNetworks.list(resourceGroupName)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    let item = _c;
                    resArray.push(item);
    ...
    it("subnets list test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resArray = new Array();
            try {
                for (var _d = true, _e = __asyncValues(client.subnets.list(resourceGroupName, virtualNetworkName)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    let item = _c;
                    resArray.push(item);
    ...
    it("ipGroups list test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resArray = new Array();
            try {
                for (var _d = true, _e = __asyncValues(client.ipGroups.listByResourceGroup(resourceGroupName)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    let item = _c;
                    resArray.push(item);
