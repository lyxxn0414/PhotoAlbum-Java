...
export class NetworkManagementClient extends coreClient.ServiceClient {
     ...
     * @param options The options parameters.
     */
    beginDeleteBastionShareableLinkByToken(resourceGroupName, bastionHostName, bslTokenRequest, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginDeleteBastionShareableLinkByTokenAndWait(resourceGroupName, bastionHostName, bslTokenRequest, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginDeleteBastionShareableLinkByToken(resourceGroupName, bastionHostName, bslTokenRequest, options);
            return poller.pollUntilDone();
        });
    }
    /**
