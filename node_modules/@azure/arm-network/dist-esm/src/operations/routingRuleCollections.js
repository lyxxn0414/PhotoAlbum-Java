...
export class RoutingRuleCollectionsImpl {
    /**
    ...
    listPagingPage(resourceGroupName, networkManagerName, configurationName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, networkManagerName, configurationName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, networkManagerName, configurationName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, networkManagerName, configurationName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, networkManagerName, configurationName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
...
//# sourceMappingURL=routingRuleCollections.js.map