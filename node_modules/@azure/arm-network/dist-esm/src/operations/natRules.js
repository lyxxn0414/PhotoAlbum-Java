...
export class NatRulesImpl {
    ...
    get(resourceGroupName, gatewayName, natRuleName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, gatewayName, natRuleName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=natRules.js.map