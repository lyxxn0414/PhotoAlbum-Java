...
export class FirewallPolicyDraftsImpl {
    /**
     ...
     */
    createOrUpdate(resourceGroupName, firewallPolicyName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, firewallPolicyName, parameters, options }, createOrUpdateOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    delete(resourceGroupName, firewallPolicyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, firewallPolicyName, options }, deleteOperationSpec);
    }
    /**
...
//# sourceMappingURL=firewallPolicyDrafts.js.map