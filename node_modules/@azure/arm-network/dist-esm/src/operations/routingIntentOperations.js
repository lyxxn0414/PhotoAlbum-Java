...
export class RoutingIntentOperationsImpl {
    /**
    ...
    get(resourceGroupName, virtualHubName, routingIntentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, virtualHubName, routingIntentName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=routingIntentOperations.js.map