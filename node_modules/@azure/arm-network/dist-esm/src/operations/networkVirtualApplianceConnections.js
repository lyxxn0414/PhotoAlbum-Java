...
export class NetworkVirtualApplianceConnectionsImpl {
     ...
     * @param options The options parameters.
     */
    beginCreateOrUpdate(resourceGroupName, networkVirtualApplianceName, connectionName, networkVirtualApplianceConnectionParameters, options) {
     ...
     * @param options The options parameters.
     */
    beginCreateOrUpdateAndWait(resourceGroupName, networkVirtualApplianceName, connectionName, networkVirtualApplianceConnectionParameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginCreateOrUpdate(resourceGroupName, networkVirtualApplianceName, connectionName, networkVirtualApplianceConnectionParameters, options);
     ...
     * @param options The options parameters.
     */
    beginDelete(resourceGroupName, networkVirtualApplianceName, connectionName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginDeleteAndWait(resourceGroupName, networkVirtualApplianceName, connectionName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginDelete(resourceGroupName, networkVirtualApplianceName, connectionName, options);
            return poller.pollUntilDone();
        });
    }
    /**
