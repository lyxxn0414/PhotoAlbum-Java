...
export class AzureFirewallsImpl {
     ...
     * @param options The options parameters.
     */
    beginPacketCapture(resourceGroupName, azureFirewallName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginPacketCaptureAndWait(resourceGroupName, azureFirewallName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginPacketCapture(resourceGroupName, azureFirewallName, parameters, options);
            return poller.pollUntilDone();
        });
    }
    /**
