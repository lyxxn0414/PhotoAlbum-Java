...
export class VpnLinkConnectionsImpl {
    ...
    getAllSharedKeysPagingPage(resourceGroupName, gatewayName, connectionName, linkConnectionName, options, settings) {
        return __asyncGenerator(this, arguments, function* getAllSharedKeysPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._getAllSharedKeys(resourceGroupName, gatewayName, connectionName, linkConnectionName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._getAllSharedKeysNext(resourceGroupName, gatewayName, connectionName, linkConnectionName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    getAllSharedKeysPagingAll(resourceGroupName, gatewayName, connectionName, linkConnectionName, options) {
        return __asyncGenerator(this, arguments, function* getAllSharedKeysPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.getAllSharedKeysPagingPage(resourceGroupName, gatewayName, connectionName, linkConnectionName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    listByVpnConnectionPagingPage(resourceGroupName, gatewayName, connectionName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByVpnConnectionPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByVpnConnection(resourceGroupName, gatewayName, connectionName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByVpnConnectionPagingAll(resourceGroupName, gatewayName, connectionName, options) {
        return __asyncGenerator(this, arguments, function* listByVpnConnectionPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByVpnConnectionPagingPage(resourceGroupName, gatewayName, connectionName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
     ...
     * @param options The options parameters.
     */
    beginSetOrInitDefaultSharedKey(resourceGroupName, gatewayName, connectionName, linkConnectionName, connectionSharedKeyParameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginSetOrInitDefaultSharedKeyAndWait(resourceGroupName, gatewayName, connectionName, linkConnectionName, connectionSharedKeyParameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginSetOrInitDefaultSharedKey(resourceGroupName, gatewayName, connectionName, linkConnectionName, connectionSharedKeyParameters, options);
            return poller.pollUntilDone();
        });
    }
    /**
