...
export class NetworkVirtualAppliancesImpl {
     ...
     * @param options The options parameters.
     */
    beginRestart(resourceGroupName, networkVirtualApplianceName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginRestartAndWait(resourceGroupName, networkVirtualApplianceName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginRestart(resourceGroupName, networkVirtualApplianceName, options);
            return poller.pollUntilDone();
        });
    }
    /**
