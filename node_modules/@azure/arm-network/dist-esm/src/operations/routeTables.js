...
export class RouteTablesImpl {
    ...
    get(resourceGroupName, routeTableName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, routeTableName, options }, getOperationSpec);
    }
    /**
    ...
    updateTags(resourceGroupName, routeTableName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, routeTableName, parameters, options }, updateTagsOperationSpec);
    }
    /**
     * Gets all route tables in a resource group.
     * @param resourceGroupName The name of the resource group.
