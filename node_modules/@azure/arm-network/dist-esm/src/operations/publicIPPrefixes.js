...
export class PublicIPPrefixesImpl {
    /**
    ...
    get(resourceGroupName, publicIpPrefixName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, publicIpPrefixName, options }, getOperationSpec);
    }
    /**
    ...
    updateTags(resourceGroupName, publicIpPrefixName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, publicIpPrefixName, parameters, options }, updateTagsOperationSpec);
    }
    /**
     * Gets all the public IP prefixes in a subscription.
     * @param options The options parameters.
...
//# sourceMappingURL=publicIPPrefixes.js.map