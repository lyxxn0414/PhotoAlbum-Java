...
export class SecurityUserRulesImpl {
    /**
     ...
     * @param options The options parameters.
     */
    createOrUpdate(resourceGroupName, networkManagerName, configurationName, ruleCollectionName, ruleName, securityUserRule, options) {
        return this.client.sendOperationRequest({
            resourceGroupName,
            networkManagerName,
            configurationName,
...
const listOperationSpec = {
    ...
    responses: {
        200: {
            bodyMapper: Mappers.SecurityUserRuleListResult,
        },
        default: {
...
const getOperationSpec = {
    ...
    responses: {
        200: {
            bodyMapper: Mappers.SecurityUserRule,
        },
        default: {
            bodyMapper: Mappers.CloudError,
        },
...
const createOrUpdateOperationSpec = {
    ...
    requestBody: Parameters.securityUserRule,
    queryParameters: [Parameters.apiVersion],
    urlParameters: [
        Parameters.$host,
        Parameters.subscriptionId,
...
//# sourceMappingURL=securityUserRules.js.map