...
export class VirtualNetworkGatewaysImpl {
    ...
    listConnectionsPagingAll(resourceGroupName, virtualNetworkGatewayName, options) {
        return __asyncGenerator(this, arguments, function* listConnectionsPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listConnectionsPagingPage(resourceGroupName, virtualNetworkGatewayName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
     ...
     * @param options The options parameters.
     */
    beginGetFailoverAllTestDetails(resourceGroupName, virtualNetworkGatewayName, typeParam, fetchLatest, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginGetFailoverAllTestDetailsAndWait(resourceGroupName, virtualNetworkGatewayName, typeParam, fetchLatest, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginGetFailoverAllTestDetails(resourceGroupName, virtualNetworkGatewayName, typeParam, fetchLatest, options);
            return poller.pollUntilDone();
        });
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginGetFailoverSingleTestDetails(resourceGroupName, virtualNetworkGatewayName, peeringLocation, failoverTestId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginGetFailoverSingleTestDetailsAndWait(resourceGroupName, virtualNetworkGatewayName, peeringLocation, failoverTestId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginGetFailoverSingleTestDetails(resourceGroupName, virtualNetworkGatewayName, peeringLocation, failoverTestId, options);
            return poller.pollUntilDone();
        });
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginStartExpressRouteSiteFailoverSimulation(resourceGroupName, virtualNetworkGatewayName, peeringLocation, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginStartExpressRouteSiteFailoverSimulationAndWait(resourceGroupName, virtualNetworkGatewayName, peeringLocation, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginStartExpressRouteSiteFailoverSimulation(resourceGroupName, virtualNetworkGatewayName, peeringLocation, options);
            return poller.pollUntilDone();
        });
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginStopExpressRouteSiteFailoverSimulation(resourceGroupName, virtualNetworkGatewayName, stopParameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginStopExpressRouteSiteFailoverSimulationAndWait(resourceGroupName, virtualNetworkGatewayName, stopParameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginStopExpressRouteSiteFailoverSimulation(resourceGroupName, virtualNetworkGatewayName, stopParameters, options);
            return poller.pollUntilDone();
        });
    }
    /**
