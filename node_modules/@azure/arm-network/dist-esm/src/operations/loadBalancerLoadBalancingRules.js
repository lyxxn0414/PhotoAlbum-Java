...
export class LoadBalancerLoadBalancingRulesImpl {
     ...
     * @param options The options parameters.
     */
    beginHealth(groupName, loadBalancerName, loadBalancingRuleName, options) {
     ...
     * @param options The options parameters.
     */
    beginHealthAndWait(groupName, loadBalancerName, loadBalancingRuleName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginHealth(groupName, loadBalancerName, loadBalancingRuleName, options);
