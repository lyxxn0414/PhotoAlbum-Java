...
export class LoadBalancerOutboundRulesImpl {
    ...
    get(resourceGroupName, loadBalancerName, outboundRuleName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, loadBalancerName, outboundRuleName, options }, getOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group.
...
//# sourceMappingURL=loadBalancerOutboundRules.js.map