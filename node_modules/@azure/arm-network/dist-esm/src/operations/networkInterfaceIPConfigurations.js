...
export class NetworkInterfaceIPConfigurationsImpl {
    ...
    get(resourceGroupName, networkInterfaceName, ipConfigurationName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, networkInterfaceName, ipConfigurationName, options }, getOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group.
...
//# sourceMappingURL=networkInterfaceIPConfigurations.js.map