...
export class CustomIPPrefixesImpl {
    /**
    ...
    get(resourceGroupName, customIpPrefixName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, customIpPrefixName, options }, getOperationSpec);
    }
    /**
    ...
    updateTags(resourceGroupName, customIpPrefixName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, customIpPrefixName, parameters, options }, updateTagsOperationSpec);
    }
    /**
     * Gets all the custom IP prefixes in a subscription.
     * @param options The options parameters.
...
//# sourceMappingURL=customIPPrefixes.js.map