...
export class FirewallPolicyRuleCollectionGroupsImpl {
    ...
    listPagingPage(resourceGroupName, firewallPolicyName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, firewallPolicyName, options));
    ...
    listPagingAll(resourceGroupName, firewallPolicyName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, firewallPolicyName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
...
//# sourceMappingURL=firewallPolicyRuleCollectionGroups.js.map