...
function getListOfServiceTags() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.serviceTagInformationOperations.list(location)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
 ...
 */
function getListOfServiceTagsWithNoAddressPrefixes() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, e_2, _b, _c;
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const location = "westeurope";
        ...
        const resArray = new Array();
        try {
            for (var _d = true, _e = __asyncValues(client.serviceTagInformationOperations.list(location, options)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
 ...
 */
function getListOfServiceTagsWithTagName() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, e_3, _b, _c;
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const location = "westeurope";
...
//# sourceMappingURL=serviceTagInformationListSample.js.map