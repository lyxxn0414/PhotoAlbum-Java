 ...
 */
function createFirewallPolicyNatRuleCollectionGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.firewallPolicyRuleCollectionGroups.beginCreateOrUpdateAndWait(resourceGroupName, firewallPolicyName, ruleCollectionGroupName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createFirewallPolicyRuleCollectionGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const firewallPolicyName = "firewallPolicy";
 ...
 */
function createFirewallPolicyRuleCollectionGroupWithWebCategories() {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function createFirewallPolicyRuleCollectionGroupWithHttpHeaderToInsert() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] ||
            "e747cc13-97d4-4a79-b463-42d7f4e558f2";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
...
//# sourceMappingURL=firewallPolicyRuleCollectionGroupsCreateOrUpdateSample.js.map