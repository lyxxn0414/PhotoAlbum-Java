 ...
 */
function networkVirtualApplianceConnectionPut() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const networkVirtualApplianceName = "nva1";
        const connectionName = "connection1";
        const networkVirtualApplianceConnectionParameters = {
        ...
        const result = yield client.networkVirtualApplianceConnections.beginCreateOrUpdateAndWait(resourceGroupName, networkVirtualApplianceName, connectionName, networkVirtualApplianceConnectionParameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=networkVirtualApplianceConnectionsCreateOrUpdateSample.js.map