 ...
 */
function startPacketCaptureOnVirtualNetworkGatewayWithFilter() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualNetworkGateways.beginStartPacketCaptureAndWait(resourceGroupName, virtualNetworkGatewayName, options);
        console.log(result);
    });
}
/**
 ...
 */
function startPacketCaptureOnVirtualNetworkGatewayWithoutFilter() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const virtualNetworkGatewayName = "vpngw";
        const credential = new DefaultAzureCredential();
        const client = new NetworkManagementClient(credential, subscriptionId);
        const result = yield client.virtualNetworkGateways.beginStartPacketCaptureAndWait(resourceGroupName, virtualNetworkGatewayName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=virtualNetworkGatewaysStartPacketCaptureSample.js.map