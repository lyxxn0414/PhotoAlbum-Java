 ...
 */
function getsASecurityUserRule() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.securityUserRules.get(resourceGroupName, networkManagerName, configurationName, ruleCollectionName, ruleName);
        console.log(result);
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        getsASecurityUserRule();
    });
}
main().catch(console.error);
//# sourceMappingURL=securityUserRulesGetSample.js.map