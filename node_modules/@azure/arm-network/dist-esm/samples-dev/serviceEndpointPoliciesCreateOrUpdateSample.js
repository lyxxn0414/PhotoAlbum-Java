 ...
 */
function createServiceEndpointPolicy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serviceEndpointPolicies.beginCreateOrUpdateAndWait(resourceGroupName, serviceEndpointPolicyName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createServiceEndpointPolicyWithDefinition() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const serviceEndpointPolicyName = "testPolicy";
...
//# sourceMappingURL=serviceEndpointPoliciesCreateOrUpdateSample.js.map