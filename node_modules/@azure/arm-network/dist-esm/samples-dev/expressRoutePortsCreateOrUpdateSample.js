 ...
 */
function expressRoutePortCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.expressRoutePorts.beginCreateOrUpdateAndWait(resourceGroupName, expressRoutePortName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function expressRoutePortUpdateLink() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const expressRoutePortName = "portName";
...
//# sourceMappingURL=expressRoutePortsCreateOrUpdateSample.js.map