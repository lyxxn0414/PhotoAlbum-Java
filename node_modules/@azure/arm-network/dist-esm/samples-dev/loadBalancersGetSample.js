...
function getLoadBalancer() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.loadBalancers.get(resourceGroupName, loadBalancerName);
        console.log(result);
    });
}
/**
 ...
 */
function getLoadBalancerWithInboundNatRulePortMapping() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const loadBalancerName = "lb";
...
//# sourceMappingURL=loadBalancersGetSample.js.map