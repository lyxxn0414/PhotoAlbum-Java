 ...
 */
function createPublicIPPrefixAllocationMethod() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.publicIPPrefixes.beginCreateOrUpdateAndWait(resourceGroupName, publicIpPrefixName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createPublicIPPrefixDefaults() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const publicIpPrefixName = "test-ipprefix";
...
//# sourceMappingURL=publicIPPrefixesCreateOrUpdateSample.js.map