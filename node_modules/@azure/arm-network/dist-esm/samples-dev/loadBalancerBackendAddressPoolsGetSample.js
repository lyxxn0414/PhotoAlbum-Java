 ...
 */
function loadBalancerWithBackendAddressPoolWithBackendAddresses() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.loadBalancerBackendAddressPools.get(resourceGroupName, loadBalancerName, backendAddressPoolName);
        console.log(result);
    });
}
/**
 ...
 */
function loadBalancerBackendAddressPoolGet() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "testrg";
        const loadBalancerName = "lb";
...
//# sourceMappingURL=loadBalancerBackendAddressPoolsGetSample.js.map