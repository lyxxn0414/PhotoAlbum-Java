...
function createAzureFirewall() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.azureFirewalls.beginCreateOrUpdateAndWait(resourceGroupName, azureFirewallName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createAzureFirewallWithManagementSubnet() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const azureFirewallName = "azurefirewall";
...
//# sourceMappingURL=azureFirewallsCreateOrUpdateSample.js.map