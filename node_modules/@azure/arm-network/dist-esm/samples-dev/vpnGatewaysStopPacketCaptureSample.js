 ...
 */
function stopPacketCaptureOnVpnGateway() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.vpnGateways.beginStopPacketCaptureAndWait(resourceGroupName, gatewayName, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=vpnGatewaysStopPacketCaptureSample.js.map