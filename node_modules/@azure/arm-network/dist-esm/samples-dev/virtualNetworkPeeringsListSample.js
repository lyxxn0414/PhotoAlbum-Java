...
function listPeerings() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.virtualNetworkPeerings.list(resourceGroupName, virtualNetworkName)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
 ...
 */
function listPeeringsWithRemoteVirtualNetworkEncryption() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, e_2, _b, _c;
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "peerTest";
...
//# sourceMappingURL=virtualNetworkPeeringsListSample.js.map