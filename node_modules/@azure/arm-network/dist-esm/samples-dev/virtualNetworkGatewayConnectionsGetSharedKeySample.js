 ...
 * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2024-05-01/examples/VirtualNetworkGatewayConnectionGetSharedKey.json
 */
function getVirtualNetworkGatewayConnectionSharedKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualNetworkGatewayConnections.getSharedKey(resourceGroupName, virtualNetworkGatewayConnectionName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=virtualNetworkGatewayConnectionsGetSharedKeySample.js.map