...
function startPacketCaptureOnVirtualNetworkGatewayConnectionWithFilter() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualNetworkGatewayConnections.beginStartPacketCaptureAndWait(resourceGroupName, virtualNetworkGatewayConnectionName, options);
        console.log(result);
    });
}
/**
 ...
 */
function startPacketCaptureOnVirtualNetworkGatewayConnectionWithoutFilter() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const virtualNetworkGatewayConnectionName = "vpngwcn1";
        const credential = new DefaultAzureCredential();
        const client = new NetworkManagementClient(credential, subscriptionId);
        const result = yield client.virtualNetworkGatewayConnections.beginStartPacketCaptureAndWait(resourceGroupName, virtualNetworkGatewayConnectionName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=virtualNetworkGatewayConnectionsStartPacketCaptureSample.js.map