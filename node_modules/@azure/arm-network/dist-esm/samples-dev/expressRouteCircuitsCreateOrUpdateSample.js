 ...
 */
function createExpressRouteCircuit() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.expressRouteCircuits.beginCreateOrUpdateAndWait(resourceGroupName, circuitName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createExpressRouteCircuitOnExpressRoutePort() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
...
//# sourceMappingURL=expressRouteCircuitsCreateOrUpdateSample.js.map