...
function getSubnet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.subnets.get(resourceGroupName, virtualNetworkName, subnetName);
        console.log(result);
    });
}
/**
 ...
 */
function getSubnetWithADelegation() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subId";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "subnet-test";
        const virtualNetworkName = "vnetname";
 ...
 */
function getSubnetWithSharingScope() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "subnet-test";
        const virtualNetworkName = "vnetname";
...
//# sourceMappingURL=subnetsGetSample.js.map