 ...
 */
function ipamPoolsGetPoolUsage() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.ipamPools.getPoolUsage(resourceGroupName, networkManagerName, poolName);
        console.log(result);
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ipamPoolsGetPoolUsage();
    });
}
main().catch(console.error);
//# sourceMappingURL=ipamPoolsGetPoolUsageSample.js.map