 ...
 * x-ms-original-file: specification/network/resource-manager/Microsoft.Network/stable/2024-05-01/examples/ExpressRouteCircuitConnectionDelete.json
 */
function deleteExpressRouteCircuit() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.expressRouteCircuitConnections.beginDeleteAndWait(resourceGroupName, circuitName, peeringName, connectionName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=expressRouteCircuitConnectionsDeleteSample.js.map