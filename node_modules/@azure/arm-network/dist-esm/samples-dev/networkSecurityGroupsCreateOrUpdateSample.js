...
function createNetworkSecurityGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.networkSecurityGroups.beginCreateOrUpdateAndWait(resourceGroupName, networkSecurityGroupName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createNetworkSecurityGroupWithRule() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const networkSecurityGroupName = "testnsg";
...
//# sourceMappingURL=networkSecurityGroupsCreateOrUpdateSample.js.map