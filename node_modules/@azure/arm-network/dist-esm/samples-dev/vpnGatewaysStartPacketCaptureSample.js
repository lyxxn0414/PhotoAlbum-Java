 ...
 */
function startPacketCaptureOnVpnGatewayWithFilter() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.vpnGateways.beginStartPacketCaptureAndWait(resourceGroupName, gatewayName, options);
        console.log(result);
    });
}
/**
 ...
 */
function startPacketCaptureOnVpnGatewayWithoutFilter() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const gatewayName = "vpngw";
        const credential = new DefaultAzureCredential();
        const client = new NetworkManagementClient(credential, subscriptionId);
        const result = yield client.vpnGateways.beginStartPacketCaptureAndWait(resourceGroupName, gatewayName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=vpnGatewaysStartPacketCaptureSample.js.map