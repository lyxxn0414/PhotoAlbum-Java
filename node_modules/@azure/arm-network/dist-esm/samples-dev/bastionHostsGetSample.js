...
function getBastionHost() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.bastionHosts.get(resourceGroupName, bastionHostName);
        console.log(result);
    });
}
/**
 ...
 */
function getBastionHostWithPrivateOnly() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const bastionHostName = "bastionhosttenant";
 ...
 */
function getBastionHostWithZones() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const bastionHostName = "bastionhosttenant";
 ...
 */
function getDeveloperBastionHost() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
...
//# sourceMappingURL=bastionHostsGetSample.js.map