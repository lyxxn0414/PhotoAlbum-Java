...
function getPrivateEndpoint() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpoints.get(resourceGroupName, privateEndpointName);
        console.log(result);
    });
}
/**
 ...
 */
function getPrivateEndpointWithApplicationSecurityGroups() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subId";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const privateEndpointName = "testPe";
 ...
 */
function getPrivateEndpointWithManualApprovalConnection() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subId";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const privateEndpointName = "testPe";
