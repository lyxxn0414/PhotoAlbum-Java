...
function createNetworkInterface() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.networkInterfaces.beginCreateOrUpdateAndWait(resourceGroupName, networkInterfaceName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createNetworkInterfaceWithGatewayLoadBalancerConsumerConfigured() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const networkInterfaceName = "test-nic";
...
//# sourceMappingURL=networkInterfacesCreateOrUpdateSample.js.map