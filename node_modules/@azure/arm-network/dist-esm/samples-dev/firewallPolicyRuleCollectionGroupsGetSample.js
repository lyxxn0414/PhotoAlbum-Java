 ...
 */
function getFirewallPolicyNatRuleCollectionGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.firewallPolicyRuleCollectionGroups.get(resourceGroupName, firewallPolicyName, ruleCollectionGroupName);
        console.log(result);
    });
}
/**
 ...
 */
function getFirewallPolicyRuleCollectionGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const firewallPolicyName = "firewallPolicy";
 ...
 */
function getFirewallPolicyRuleCollectionGroupWithIPGroups() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["NETWORK_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["NETWORK_RESOURCE_GROUP"] || "rg1";
        const firewallPolicyName = "firewallPolicy";
 ...
 */
function getFirewallPolicyRuleCollectionGroupWithWebCategories() {
    return __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=firewallPolicyRuleCollectionGroupsGetSample.js.map