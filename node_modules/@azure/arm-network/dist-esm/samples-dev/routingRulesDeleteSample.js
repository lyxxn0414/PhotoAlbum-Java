...
function deletesARoutingRule() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.routingRules.beginDeleteAndWait(resourceGroupName, networkManagerName, configurationName, ruleCollectionName, ruleName, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=routingRulesDeleteSample.js.map