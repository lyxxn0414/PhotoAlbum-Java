...
exports.ContainerAppsSessionPoolsImpl = void 0;
...
class ContainerAppsSessionPoolsImpl {
    /**
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, sessionPoolName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, sessionPoolName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, sessionPoolName, sessionPoolEnvelope, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, sessionPoolName, sessionPoolEnvelope, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, sessionPoolName, sessionPoolEnvelope, options);
     ...
     * @param options The options parameters.
     */
    async beginUpdate(resourceGroupName, sessionPoolName, sessionPoolEnvelope, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateAndWait(resourceGroupName, sessionPoolName, sessionPoolEnvelope, options) {
        const poller = await this.beginUpdate(resourceGroupName, sessionPoolName, sessionPoolEnvelope, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, sessionPoolName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, sessionPoolName, options) {
...
exports.ContainerAppsSessionPoolsImpl = ContainerAppsSessionPoolsImpl;
...
//# sourceMappingURL=containerAppsSessionPools.js.map