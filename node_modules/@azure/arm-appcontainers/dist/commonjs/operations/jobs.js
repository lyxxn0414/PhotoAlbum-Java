...
class JobsImpl {
    ...
    listDetectorsPagingPage(resourceGroupName, jobName, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listDetectorsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listDetectors(resourceGroupName, jobName, options));
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listDetectorsNext(resourceGroupName, jobName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listDetectorsPagingAll(resourceGroupName, jobName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listDetectorsPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listDetectorsPagingPage(resourceGroupName, jobName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, jobName, jobEnvelope, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, jobName, jobEnvelope, options) {
     ...
     * @param options The options parameters.
     */
    async beginUpdate(resourceGroupName, jobName, jobEnvelope, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateAndWait(resourceGroupName, jobName, jobEnvelope, options) {
     ...
     * @param options The options parameters.
     */
    async beginStart(resourceGroupName, jobName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginStartAndWait(resourceGroupName, jobName, options) {
     ...
     * @param options The options parameters.
     */
    async beginStopExecution(resourceGroupName, jobName, jobExecutionName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginStopExecutionAndWait(resourceGroupName, jobName, jobExecutionName, options) {
        const poller = await this.beginStopExecution(resourceGroupName, jobName, jobExecutionName, options);
        return poller.pollUntilDone();
    }
    /**
     * Terminates execution of a running container apps job
     ...
     * @param options The options parameters.
     */
    async beginStopMultipleExecutions(resourceGroupName, jobName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginStopMultipleExecutionsAndWait(resourceGroupName, jobName, options) {
    ...
    listSecrets(resourceGroupName, jobName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, jobName, options }, listSecretsOperationSpec);
    }
    /**
     * ListDetectorsNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
