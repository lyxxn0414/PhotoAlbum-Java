...
class ConnectedEnvironmentsDaprComponentsImpl {
    ...
    listPagingPage(resourceGroupName, connectedEnvironmentName, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield tslib_1.__await(this._list(resourceGroupName, connectedEnvironmentName, options));
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listNext(resourceGroupName, connectedEnvironmentName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listPagingAll(resourceGroupName, connectedEnvironmentName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listPagingPage(resourceGroupName, connectedEnvironmentName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    _list(resourceGroupName, connectedEnvironmentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, connectedEnvironmentName, options }, listOperationSpec);
    }
    /**
    ...
    get(resourceGroupName, connectedEnvironmentName, componentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, connectedEnvironmentName, componentName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, connectedEnvironmentName, componentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, connectedEnvironmentName, componentName, options }, deleteOperationSpec);
    }
    /**
    ...
    listSecrets(resourceGroupName, connectedEnvironmentName, componentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, connectedEnvironmentName, componentName, options }, listSecretsOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
    ...
    _listNext(resourceGroupName, connectedEnvironmentName, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, connectedEnvironmentName, nextLink, options }, listNextOperationSpec);
    }
}
exports.ConnectedEnvironmentsDaprComponentsImpl = ConnectedEnvironmentsDaprComponentsImpl;
...
//# sourceMappingURL=connectedEnvironmentsDaprComponents.js.map