...
exports.ContainerAppsSourceControlsImpl = void 0;
...
class ContainerAppsSourceControlsImpl {
    ...
    listByContainerAppPagingPage(resourceGroupName, containerAppName, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listByContainerAppPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listByContainerApp(resourceGroupName, containerAppName, options));
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listByContainerAppNext(resourceGroupName, containerAppName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listByContainerAppPagingAll(resourceGroupName, containerAppName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listByContainerAppPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listByContainerAppPagingPage(resourceGroupName, containerAppName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, containerAppName, sourceControlName, sourceControlEnvelope, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, containerAppName, sourceControlName, sourceControlEnvelope, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, containerAppName, sourceControlName, sourceControlEnvelope, options);
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, containerAppName, sourceControlName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, containerAppName, sourceControlName, options) {
        const poller = await this.beginDelete(resourceGroupName, containerAppName, sourceControlName, options);
        return poller.pollUntilDone();
    }
    /**
...
exports.ContainerAppsSourceControlsImpl = ContainerAppsSourceControlsImpl;
...
//# sourceMappingURL=containerAppsSourceControls.js.map