...
exports.ContainerAppsRevisionsImpl = void 0;
...
class ContainerAppsRevisionsImpl {
    ...
    listRevisionsPagingPage(resourceGroupName, containerAppName, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listRevisionsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listRevisions(resourceGroupName, containerAppName, options));
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listRevisionsNext(resourceGroupName, containerAppName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listRevisionsPagingAll(resourceGroupName, containerAppName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listRevisionsPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listRevisionsPagingPage(resourceGroupName, containerAppName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
...
exports.ContainerAppsRevisionsImpl = ContainerAppsRevisionsImpl;
