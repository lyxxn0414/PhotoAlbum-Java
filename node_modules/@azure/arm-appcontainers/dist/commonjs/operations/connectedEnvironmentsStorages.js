...
exports.ConnectedEnvironmentsStoragesImpl = void 0;
...
class ConnectedEnvironmentsStoragesImpl {
    ...
    get(resourceGroupName, connectedEnvironmentName, storageName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, connectedEnvironmentName, storageName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, connectedEnvironmentName, storageName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, connectedEnvironmentName, storageName, options }, deleteOperationSpec);
    }
}
exports.ConnectedEnvironmentsStoragesImpl = ConnectedEnvironmentsStoragesImpl;
...
//# sourceMappingURL=connectedEnvironmentsStorages.js.map