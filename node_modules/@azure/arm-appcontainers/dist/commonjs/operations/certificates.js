...
exports.CertificatesImpl = void 0;
...
class CertificatesImpl {
    ...
    get(resourceGroupName, environmentName, certificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, certificateName, options }, getOperationSpec);
    }
    /**
    ...
    createOrUpdate(resourceGroupName, environmentName, certificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, certificateName, options }, createOrUpdateOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, environmentName, certificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, certificateName, options }, deleteOperationSpec);
    }
    /**
...
exports.CertificatesImpl = CertificatesImpl;
