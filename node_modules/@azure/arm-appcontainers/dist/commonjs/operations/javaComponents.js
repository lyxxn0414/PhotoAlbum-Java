...
exports.JavaComponentsImpl = void 0;
...
class JavaComponentsImpl {
    ...
    listPagingPage(resourceGroupName, environmentName, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield tslib_1.__await(this._list(resourceGroupName, environmentName, options));
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listNext(resourceGroupName, environmentName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
    ...
    listPagingAll(resourceGroupName, environmentName, options) {
        return tslib_1.__asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = tslib_1.__asyncValues(this.listPagingPage(resourceGroupName, environmentName, options)), _f; _f = yield tslib_1.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, environmentName, name, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, name, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, environmentName, name, javaComponentEnvelope, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, environmentName, name, javaComponentEnvelope, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, environmentName, name, javaComponentEnvelope, options);
     ...
     * @param options The options parameters.
     */
    async beginUpdate(resourceGroupName, environmentName, name, javaComponentEnvelope, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateAndWait(resourceGroupName, environmentName, name, javaComponentEnvelope, options) {
        const poller = await this.beginUpdate(resourceGroupName, environmentName, name, javaComponentEnvelope, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, environmentName, name, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, environmentName, name, options) {
...
exports.JavaComponentsImpl = JavaComponentsImpl;
...
//# sourceMappingURL=javaComponents.js.map