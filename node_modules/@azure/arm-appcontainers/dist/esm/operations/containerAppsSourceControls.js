...
export class ContainerAppsSourceControlsImpl {
    ...
    listByContainerAppPagingPage(resourceGroupName, containerAppName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByContainerAppPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByContainerApp(resourceGroupName, containerAppName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByContainerAppNext(resourceGroupName, containerAppName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByContainerAppPagingAll(resourceGroupName, containerAppName, options) {
        return __asyncGenerator(this, arguments, function* listByContainerAppPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByContainerAppPagingPage(resourceGroupName, containerAppName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
