...
export class ContainerAppsAuthConfigsImpl {
    ...
    get(resourceGroupName, containerAppName, authConfigName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, containerAppName, authConfigName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, containerAppName, authConfigName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, containerAppName, authConfigName, options }, deleteOperationSpec);
    }
    /**
...
//# sourceMappingURL=containerAppsAuthConfigs.js.map