...
export class ConnectedEnvironmentsCertificatesImpl {
    ...
    listPagingPage(resourceGroupName, connectedEnvironmentName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, connectedEnvironmentName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, connectedEnvironmentName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, connectedEnvironmentName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, connectedEnvironmentName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    get(resourceGroupName, connectedEnvironmentName, certificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, connectedEnvironmentName, certificateName, options }, getOperationSpec);
    }
    /**
    ...
    createOrUpdate(resourceGroupName, connectedEnvironmentName, certificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, connectedEnvironmentName, certificateName, options }, createOrUpdateOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, connectedEnvironmentName, certificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, connectedEnvironmentName, certificateName, options }, deleteOperationSpec);
    }
    /**
...
//# sourceMappingURL=connectedEnvironmentsCertificates.js.map