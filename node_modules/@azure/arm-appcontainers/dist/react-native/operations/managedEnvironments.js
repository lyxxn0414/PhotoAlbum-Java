...
export class ManagedEnvironmentsImpl {
    /**
    ...
    listWorkloadProfileStatesPagingPage(resourceGroupName, environmentName, options, settings) {
        return __asyncGenerator(this, arguments, function* listWorkloadProfileStatesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listWorkloadProfileStates(resourceGroupName, environmentName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listWorkloadProfileStatesNext(resourceGroupName, environmentName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listWorkloadProfileStatesPagingAll(resourceGroupName, environmentName, options) {
        return __asyncGenerator(this, arguments, function* listWorkloadProfileStatesPagingAll_1() {
            var _a, e_3, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listWorkloadProfileStatesPagingPage(resourceGroupName, environmentName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, environmentName, environmentEnvelope, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, environmentName, environmentEnvelope, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, environmentName, environmentEnvelope, options);
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, environmentName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, environmentName, options) {
        const poller = await this.beginDelete(resourceGroupName, environmentName, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginUpdate(resourceGroupName, environmentName, environmentEnvelope, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateAndWait(resourceGroupName, environmentName, environmentEnvelope, options) {
        const poller = await this.beginUpdate(resourceGroupName, environmentName, environmentEnvelope, options);
        return poller.pollUntilDone();
    }
    /**
...
//# sourceMappingURL=managedEnvironments.js.map