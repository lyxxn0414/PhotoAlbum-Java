...
export class ManagedCertificatesImpl {
    /**
    ...
    get(resourceGroupName, environmentName, managedCertificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, managedCertificateName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, environmentName, managedCertificateName, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, environmentName, managedCertificateName, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, environmentName, managedCertificateName, options);
    ...
    delete(resourceGroupName, environmentName, managedCertificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, environmentName, managedCertificateName, options }, deleteOperationSpec);
    }
    /**
...
//# sourceMappingURL=managedCertificates.js.map