...
export class ContainerAppsImpl {
    ...
    get(resourceGroupName, containerAppName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, containerAppName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, containerAppName, containerAppEnvelope, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, containerAppName, containerAppEnvelope, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, containerAppName, containerAppEnvelope, options);
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, containerAppName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, containerAppName, options) {
     ...
     * @param options The options parameters.
     */
    async beginUpdate(resourceGroupName, containerAppName, containerAppEnvelope, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpdateAndWait(resourceGroupName, containerAppName, containerAppEnvelope, options) {
        const poller = await this.beginUpdate(resourceGroupName, containerAppName, containerAppEnvelope, options);
        return poller.pollUntilDone();
    }
    /**
    ...
    listSecrets(resourceGroupName, containerAppName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, containerAppName, options }, listSecretsOperationSpec);
    }
    /**
    ...
    getAuthToken(resourceGroupName, containerAppName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, containerAppName, options }, getAuthTokenOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginStart(resourceGroupName, containerAppName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginStartAndWait(resourceGroupName, containerAppName, options) {
     ...
     * @param options The options parameters.
     */
    async beginStop(resourceGroupName, containerAppName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginStopAndWait(resourceGroupName, containerAppName, options) {
