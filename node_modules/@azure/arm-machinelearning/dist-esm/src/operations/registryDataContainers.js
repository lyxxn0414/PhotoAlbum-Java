...
export class RegistryDataContainersImpl {
    /**
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, registryName, name, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, name, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=registryDataContainers.js.map