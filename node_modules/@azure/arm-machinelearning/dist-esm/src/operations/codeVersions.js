...
export class CodeVersionsImpl {
    ...
    listPagingPage(resourceGroupName, workspaceName, name, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, workspaceName, name, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, workspaceName, name, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, workspaceName, name, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, workspaceName, name, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    _list(resourceGroupName, workspaceName, name, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, name, options }, listOperationSpec);
    }
    /**
     * Delete version.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
    ...
    delete(resourceGroupName, workspaceName, name, version, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, name, version, options }, deleteOperationSpec);
    }
    /**
     * Get version.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
    ...
    get(resourceGroupName, workspaceName, name, version, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, name, version, options }, getOperationSpec);
    }
    /**
    ...
    createOrUpdate(resourceGroupName, workspaceName, name, version, body, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, name, version, body, options }, createOrUpdateOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    createOrGetStartPendingUpload(resourceGroupName, workspaceName, name, version, body, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, name, version, body, options }, createOrGetStartPendingUploadOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
    ...
    _listNext(resourceGroupName, workspaceName, name, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, name, nextLink, options }, listNextOperationSpec);
    }
}
...
//# sourceMappingURL=codeVersions.js.map