...
export class RegistryEnvironmentVersionsImpl {
     ...
     */
    list(resourceGroupName, registryName, environmentName, options) {
    ...
    listPagingPage(resourceGroupName, registryName, environmentName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, registryName, environmentName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, registryName, environmentName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, registryName, environmentName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, registryName, environmentName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
     ...
     * @param options The options parameters.
     */
    _list(resourceGroupName, registryName, environmentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, environmentName, options }, listOperationSpec);
    }
    /**
     * Delete version.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, registryName, environmentName, version, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, environmentName, version, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    _listNext(resourceGroupName, registryName, environmentName, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, environmentName, nextLink, options }, listNextOperationSpec);
    }
}
...
//# sourceMappingURL=registryEnvironmentVersions.js.map