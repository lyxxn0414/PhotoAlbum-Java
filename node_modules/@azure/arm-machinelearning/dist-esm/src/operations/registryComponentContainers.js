...
export class RegistryComponentContainersImpl {
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, registryName, componentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, componentName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=registryComponentContainers.js.map