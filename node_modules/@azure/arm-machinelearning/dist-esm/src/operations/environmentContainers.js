...
export class EnvironmentContainersImpl {
    /**
    ...
    createOrUpdate(resourceGroupName, workspaceName, name, body, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, name, body, options }, createOrUpdateOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
...
//# sourceMappingURL=environmentContainers.js.map