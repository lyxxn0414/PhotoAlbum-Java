...
export class ServerlessEndpointsImpl {
    /**
     ...
     * @param options The options parameters.
     */
    listKeys(resourceGroupName, workspaceName, name, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, name, options }, listKeysOperationSpec);
    }
    /**
...
//# sourceMappingURL=serverlessEndpoints.js.map