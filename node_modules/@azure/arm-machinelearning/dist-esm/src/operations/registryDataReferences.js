...
export class RegistryDataReferencesImpl {
    /**
     ...
     */
    getBlobReferenceSAS(resourceGroupName, registryName, name, version, body, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, name, version, body, options }, getBlobReferenceSASOperationSpec);
    }
}
// Operation Specifications
const serializer = coreClient.createSerializer(Mappers, /* isXml */ false);
const getBlobReferenceSASOperationSpec = {
...
//# sourceMappingURL=registryDataReferences.js.map