...
export class WorkspaceConnectionsImpl {
    /**
     ...
     * @param options The options parameters.
     */
    listSecrets(resourceGroupName, workspaceName, connectionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, connectionName, options }, listSecretsOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
...
//# sourceMappingURL=workspaceConnections.js.map