...
export class RegistryModelVersionsImpl {
    /**
     ...
     */
    list(resourceGroupName, registryName, modelName, options) {
    ...
    listPagingPage(resourceGroupName, registryName, modelName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, registryName, modelName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, registryName, modelName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, registryName, modelName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, registryName, modelName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
     ...
     * @param options The options parameters.
     */
    _list(resourceGroupName, registryName, modelName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, modelName, options }, listOperationSpec);
    }
    /**
     * Delete version.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, registryName, modelName, version, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, modelName, version, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    createOrGetStartPendingUpload(resourceGroupName, registryName, modelName, version, body, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, modelName, version, body, options }, createOrGetStartPendingUploadOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     ...
     * @param options The options parameters.
     */
    _listNext(resourceGroupName, registryName, modelName, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, modelName, nextLink, options }, listNextOperationSpec);
    }
}
...
const createOrGetStartPendingUploadOperationSpec = {
...
//# sourceMappingURL=registryModelVersions.js.map