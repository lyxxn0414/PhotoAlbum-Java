...
export class RegistryEnvironmentContainersImpl {
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, registryName, environmentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, environmentName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=registryEnvironmentContainers.js.map