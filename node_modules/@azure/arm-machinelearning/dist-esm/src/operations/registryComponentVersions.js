...
export class RegistryComponentVersionsImpl {
     ...
     */
    list(resourceGroupName, registryName, componentName, options) {
        const iter = this.listPagingAll(resourceGroupName, registryName, componentName, options);
        return {
            next() {
                return iter.next();
            },
    ...
    listPagingPage(resourceGroupName, registryName, componentName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, registryName, componentName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, registryName, componentName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, registryName, componentName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, registryName, componentName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
     ...
     * @param options The options parameters.
     */
    _list(resourceGroupName, registryName, componentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, componentName, options }, listOperationSpec);
    }
    /**
     * Delete version.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, registryName, componentName, version, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, componentName, version, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    _listNext(resourceGroupName, registryName, componentName, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, componentName, nextLink, options }, listNextOperationSpec);
    }
}
...
//# sourceMappingURL=registryComponentVersions.js.map