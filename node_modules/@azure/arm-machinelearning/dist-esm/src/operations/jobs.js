...
export class JobsImpl {
    ...
    get(resourceGroupName, workspaceName, id, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, id, options }, getOperationSpec);
    }
    /**
    ...
    createOrUpdate(resourceGroupName, workspaceName, id, body, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, id, body, options }, createOrUpdateOperationSpec);
    }
    /**
