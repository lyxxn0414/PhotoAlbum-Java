...
export class ComputeOperationsImpl {
    /**
    ...
    listNodesPagingPage(resourceGroupName, workspaceName, computeName, options, settings) {
        return __asyncGenerator(this, arguments, function* listNodesPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listNodes(resourceGroupName, workspaceName, computeName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNodesNext(resourceGroupName, workspaceName, computeName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.nodes || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listNodesPagingAll(resourceGroupName, workspaceName, computeName, options) {
        return __asyncGenerator(this, arguments, function* listNodesPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listNodesPagingPage(resourceGroupName, workspaceName, computeName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
    ...
    get(resourceGroupName, workspaceName, computeName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, computeName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=computeOperations.js.map