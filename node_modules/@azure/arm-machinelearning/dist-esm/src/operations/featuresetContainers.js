...
export class FeaturesetContainersImpl {
    /**
     ...
     * @param options The options parameters.
     */
    getEntity(resourceGroupName, workspaceName, name, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, name, options }, getEntityOperationSpec);
    }
    /**
...
//# sourceMappingURL=featuresetContainers.js.map