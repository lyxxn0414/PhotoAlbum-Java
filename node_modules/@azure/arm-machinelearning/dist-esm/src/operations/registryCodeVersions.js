...
export class RegistryCodeVersionsImpl {
    /**
     ...
     */
    list(resourceGroupName, registryName, codeName, options) {
    ...
    listPagingPage(resourceGroupName, registryName, codeName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, registryName, codeName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, registryName, codeName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, registryName, codeName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, registryName, codeName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
     ...
     * @param options The options parameters.
     */
    _list(resourceGroupName, registryName, codeName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, codeName, options }, listOperationSpec);
    }
    /**
     * Delete version.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, registryName, codeName, version, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, codeName, version, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    createOrGetStartPendingUpload(resourceGroupName, registryName, codeName, version, body, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, codeName, version, body, options }, createOrGetStartPendingUploadOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     ...
     * @param options The options parameters.
     */
    _listNext(resourceGroupName, registryName, codeName, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, codeName, nextLink, options }, listNextOperationSpec);
    }
}
...
//# sourceMappingURL=registryCodeVersions.js.map