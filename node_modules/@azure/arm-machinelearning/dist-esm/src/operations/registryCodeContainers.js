...
export class RegistryCodeContainersImpl {
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, registryName, codeName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, registryName, codeName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=registryCodeContainers.js.map