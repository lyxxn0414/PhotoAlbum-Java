...
export class OnlineDeploymentsImpl {
    /**
    ...
    listPagingAll(resourceGroupName, workspaceName, endpointName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, workspaceName, endpointName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    listSkusPagingPage(resourceGroupName, workspaceName, endpointName, deploymentName, options, settings) {
        return __asyncGenerator(this, arguments, function* listSkusPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listSkus(resourceGroupName, workspaceName, endpointName, deploymentName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listSkusNext(resourceGroupName, workspaceName, endpointName, deploymentName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listSkusPagingAll(resourceGroupName, workspaceName, endpointName, deploymentName, options) {
        return __asyncGenerator(this, arguments, function* listSkusPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listSkusPagingPage(resourceGroupName, workspaceName, endpointName, deploymentName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
...
//# sourceMappingURL=onlineDeployments.js.map