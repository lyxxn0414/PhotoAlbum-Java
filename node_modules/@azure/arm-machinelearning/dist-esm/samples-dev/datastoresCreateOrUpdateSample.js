 ...
 */
function createOrUpdateDatastoreAzureDataLakeGen1WOrServicePrincipal() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["MACHINELEARNING_SUBSCRIPTION_ID"] ||
        ...
        const result = yield client.datastores.createOrUpdate(resourceGroupName, workspaceName, name, body, options);
        console.log(result);
    });
}
/**
 ...
 */
function createOrUpdateDatastoreAzureDataLakeGen2WOrServicePrincipal() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["MACHINELEARNING_SUBSCRIPTION_ID"] ||
            "00000000-1111-2222-3333-444444444444";
        const resourceGroupName = process.env["MACHINELEARNING_RESOURCE_GROUP"] || "test-rg";
 ...
 */
function createOrUpdateDatastoreAzureFileStoreWOrAccountKey() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["MACHINELEARNING_SUBSCRIPTION_ID"] ||
            "00000000-1111-2222-3333-444444444444";
        const resourceGroupName = process.env["MACHINELEARNING_RESOURCE_GROUP"] || "test-rg";
 ...
 */
function createOrUpdateDatastoreAzureBlobWOrAccountKey() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["MACHINELEARNING_SUBSCRIPTION_ID"] ||
            "00000000-1111-2222-3333-444444444444";
        const resourceGroupName = process.env["MACHINELEARNING_RESOURCE_GROUP"] || "test-rg";
...
//# sourceMappingURL=datastoresCreateOrUpdateSample.js.map