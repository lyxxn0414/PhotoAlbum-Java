 ...
 */
function getWorkspaceModelContainer() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.modelContainers.get(resourceGroupName, workspaceName, name);
        console.log(result);
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        getWorkspaceModelContainer();
    });
}
main().catch(console.error);
//# sourceMappingURL=modelContainersGetSample.js.map