 ...
 */
function regenerateKeysWorkspaceServerlessEndpoint() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serverlessEndpoints.beginRegenerateKeysAndWait(resourceGroupName, workspaceName, name, body);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=serverlessEndpointsRegenerateKeysSample.js.map