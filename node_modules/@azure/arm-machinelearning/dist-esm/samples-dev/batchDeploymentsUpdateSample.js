 ...
 */
function updateWorkspaceBatchDeployment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const body = { properties: { description: "string" }, tags: {} };
        const credential = new DefaultAzureCredential();
        const client = new AzureMachineLearningServicesManagementClient(credential, subscriptionId);
        const result = yield client.batchDeployments.beginUpdateAndWait(resourceGroupName, workspaceName, endpointName, deploymentName, body);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=batchDeploymentsUpdateSample.js.map