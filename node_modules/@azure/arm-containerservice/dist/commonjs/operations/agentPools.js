...
class AgentPoolsImpl {
     ...
     * @param options The options parameters.
     */
    async beginAbortLatestOperation(resourceGroupName, resourceName, agentPoolName, options) {
     ...
     * @param options The options parameters.
     */
    async beginAbortLatestOperationAndWait(resourceGroupName, resourceName, agentPoolName, options) {
        const poller = await this.beginAbortLatestOperation(resourceGroupName, resourceName, agentPoolName, options);
    ...
    get(resourceGroupName, resourceName, agentPoolName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, resourceName, agentPoolName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, resourceName, agentPoolName, parameters, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, resourceName, agentPoolName, parameters, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, resourceName, agentPoolName, parameters, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, resourceName, agentPoolName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, resourceName, agentPoolName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteMachines(resourceGroupName, resourceName, agentPoolName, machines, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteMachinesAndWait(resourceGroupName, resourceName, agentPoolName, machines, options) {
        const poller = await this.beginDeleteMachines(resourceGroupName, resourceName, agentPoolName, machines, options);
        return poller.pollUntilDone();
    }
    /**
     ...
     * @param options The options parameters.
     */
    async beginUpgradeNodeImageVersion(resourceGroupName, resourceName, agentPoolName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginUpgradeNodeImageVersionAndWait(resourceGroupName, resourceName, agentPoolName, options) {
        const poller = await this.beginUpgradeNodeImageVersion(resourceGroupName, resourceName, agentPoolName, options);
        return poller.pollUntilDone();
    }
    /**
     * ListNext
...
exports.AgentPoolsImpl = AgentPoolsImpl;
