...
class MaintenanceConfigurationsImpl {
    ...
    async *listByManagedClusterPagingPage(resourceGroupName, resourceName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listByManagedClusterNext(resourceGroupName, resourceName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listByManagedClusterPagingAll(resourceGroupName, resourceName, options) {
        for await (const page of this.listByManagedClusterPagingPage(resourceGroupName, resourceName, options)) {
            yield* page;
        }
    }
    /**
