...
class TrustedAccessRoleBindingsImpl {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdate(resourceGroupName, resourceName, trustedAccessRoleBindingName, trustedAccessRoleBinding, options) {
     ...
     * @param options The options parameters.
     */
    async beginCreateOrUpdateAndWait(resourceGroupName, resourceName, trustedAccessRoleBindingName, trustedAccessRoleBinding, options) {
        const poller = await this.beginCreateOrUpdate(resourceGroupName, resourceName, trustedAccessRoleBindingName, trustedAccessRoleBinding, options);
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, resourceName, trustedAccessRoleBindingName, options) {
        const directSendOperation = async (args, spec) => {
            return this.client.sendOperationRequest(args, spec);
        };
        const sendOperationFn = async (args, spec) => {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, resourceName, trustedAccessRoleBindingName, options) {
        const poller = await this.beginDelete(resourceGroupName, resourceName, trustedAccessRoleBindingName, options);
        return poller.pollUntilDone();
    }
    /**
     * ListNext
...
exports.TrustedAccessRoleBindingsImpl = TrustedAccessRoleBindingsImpl;
