...
class MachinesImpl {
    ...
    async *listPagingPage(resourceGroupName, resourceName, agentPoolName, options, settings) {
        let result;
        ...
        while (continuationToken) {
            result = await this._listNext(resourceGroupName, resourceName, agentPoolName, continuationToken, options);
            continuationToken = result.nextLink;
            const page = result.value || [];
            (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
            yield page;
    ...
    async *listPagingAll(resourceGroupName, resourceName, agentPoolName, options) {
        for await (const page of this.listPagingPage(resourceGroupName, resourceName, agentPoolName, options)) {
            yield* page;
        }
    }
    /**
...
exports.MachinesImpl = MachinesImpl;
