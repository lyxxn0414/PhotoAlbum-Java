...
exports.KeyVaultManagementClient = void 0;
...
class KeyVaultManagementClient extends coreClient.ServiceClient {
    ...
    constructor(credentials, subscriptionId, options) {
        ...
        this.managedHsms = new index_js_1.ManagedHsmsImpl(this);
        this.vaults = new index_js_1.VaultsImpl(this);
        this.managedHsmKeys = new index_js_1.ManagedHsmKeysImpl(this);
        this.mhsmPrivateEndpointConnections = new index_js_1.MhsmPrivateEndpointConnectionsImpl(this);
        this.mhsmPrivateLinkResources = new index_js_1.MhsmPrivateLinkResourcesImpl(this);
        this.mhsmRegions = new index_js_1.MhsmRegionsImpl(this);
        this.keys = new index_js_1.KeysImpl(this);
