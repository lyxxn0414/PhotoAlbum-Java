...
exports.ManagedHsmKeysImpl = void 0;
...
class ManagedHsmKeysImpl {
    ...
    async *listPagingPage(resourceGroupName, name, options, settings) {
        let result;
    ...
    async *listPagingAll(resourceGroupName, name, options) {
    ...
    async *listVersionsPagingPage(resourceGroupName, name, keyName, options, settings) {
        let result;
        let continuationToken = settings?.continuationToken;
        if (!continuationToken) {
    ...
    async *listVersionsPagingAll(resourceGroupName, name, keyName, options) {
        for await (const page of this.listVersionsPagingPage(resourceGroupName, name, keyName, options)) {
            yield* page;
        }
    }
    /**
...
exports.ManagedHsmKeysImpl = ManagedHsmKeysImpl;
...
//# sourceMappingURL=managedHsmKeys.js.map