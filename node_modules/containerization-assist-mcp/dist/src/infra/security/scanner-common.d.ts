 ...
 */
export declare const ScannerErrors: {
    /**
 ...
 */
export declare function validateImageId(imageId: string): boolean;
/**
 ...
 */
export declare function normalizeSeverity(severity: string): StandardSeverity;
/**
 * Severity counter helper
 */
export declare class SeverityCounter {
    critical: number;
    high: number;
    medium: number;
    low: number;
 ...
 */
export declare function logScanStart(logger: Logger, scanner: string, version: string, imageId: string): void;
/**
 * Log scan completion
 */
export declare function logScanComplete(logger: Logger, scanner: string, imageId: string, totalVulnerabilities: number, criticalCount: number, highCount: number): void;
//# sourceMappingURL=scanner-common.d.ts.map