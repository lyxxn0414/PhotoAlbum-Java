 ...
 */
export declare function checkTrivyAvailability(logger: Logger): Promise<Result<string>>;
/**
 * Scan a Docker image using Trivy
 */
export declare function scanImageWithTrivy(imageId: string, logger: Logger): Promise<Result<BasicScanResult>>;
//# sourceMappingURL=trivy-scanner.d.ts.map