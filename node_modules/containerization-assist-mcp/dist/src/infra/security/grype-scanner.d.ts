...
import type { BasicScanResult } from './scanner.js';
/**
 * Check if Grype is installed and accessible
 */
export declare function checkGrypeAvailability(logger: Logger): Promise<Result<string>>;
/**
 * Scan a Docker image using Grype
 */
export declare function scanImageWithGrype(imageId: string, logger: Logger): Promise<Result<BasicScanResult>>;
//# sourceMappingURL=grype-scanner.d.ts.map