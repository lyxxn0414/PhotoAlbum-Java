...
import { tagImageSchema } from './schema.js';
import { summarizeList } from '../../lib/summary-helpers.js';
/**
 * Tag image handler
 */
async function handleTagImage(input, ctx) {
    ...
    try {
        ...
        if (!tagResult.ok) {
            return Failure(`Failed to tag image: ${tagResult.error ?? 'Unknown error'}`, tagResult.guidance);
        }
        const tags = [tag];
        // Generate summary
