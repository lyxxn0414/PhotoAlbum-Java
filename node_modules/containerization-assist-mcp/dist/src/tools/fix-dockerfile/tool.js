 ...
 */
import { Success, TOPICS } from '../../types/index.js';
import { getToolLogger } from '../../lib/tool-helpers.js';
import { LIMITS } from '../../config/constants.js';
import { fixDockerfileSchema, } from './schema.js';
...
import { validateDockerfileContent } from '../../validation/dockerfile-validator.js';
import { ValidationCategory, ValidationSeverity } from '../../validation/core-types.js';
...
async function handleFixDockerfile(input, ctx) {
    ...
    if (ctx.policy) {
        ...
        policyValidation = await validateContentAgainstPolicy(content, ctx.policy, logger, 'Dockerfile');
        logger.info({
