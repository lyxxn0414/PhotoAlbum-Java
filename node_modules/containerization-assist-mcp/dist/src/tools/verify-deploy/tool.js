...
import { verifyDeployToolDefinition } from './types.js';
import { DEFAULT_TIMEOUTS } from '../../config/constants.js';
import { Success, Failure } from '../../types/index.js';
import { buildStatusSummary } from '../../lib/summary-helpers.js';
/**
...
async function handleVerifyDeployment(params, context) {
    ...
    try {
        ...
        // Generate summary
        const summary = buildStatusSummary(isSuccessful, `Deployment ${deploymentName} is healthy. ${health.readyReplicas}/${health.totalReplicas} pods ready. All health checks passing.`, `Deployment ${deploymentName} has issues. ${health.readyReplicas}/${health.totalReplicas} pods ready. Check pod logs for details.`);
        // Prepare the result
        const result = {
            summary,
