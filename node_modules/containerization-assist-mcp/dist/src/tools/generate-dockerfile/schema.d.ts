 ...
 */
import { z } from 'zod';
import { DOCKER_PLATFORMS, type DockerPlatform, type ToolNextAction } from '../shared/schemas.js';
import { ModuleInfo } from '../analyze-repo/schema.js';
import type { PolicyValidationResult } from '../../lib/policy-helpers.js';
export { DOCKER_PLATFORMS, type DockerPlatform };
export declare const generateDockerfileSchema: z.ZodObject<{
