...
import { type ToolOrchestrator, type OrchestratorConfig } from './orchestrator-types.js';
 ...
 */
export declare function discoverBuiltInPolicies(logger: Logger): string[];
/**
 * Discover policies in policies.user/ directory (source installation)
 * Returns paths to all .rego files (excluding test files)
 */
export declare function discoverUserPolicies(logger: Logger): string[];
/**
 * Discover policies in custom directory (NPM installation)
 * Returns paths to all .rego files (excluding test files)
 */
export declare function discoverCustomPolicies(customPath: string, logger: Logger): string[];
/**
 ...
 */
export declare function discoverPolicies(logger: Logger): string[];
/**
 * Create a tool orchestrator
 */
export declare function createOrchestrator<T extends Tool<ZodTypeAny, any>>(options: {
