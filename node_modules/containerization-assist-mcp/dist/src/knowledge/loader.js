...
import { EMBEDDED_PACKS } from './embedded-packs.js';
import { z } from 'zod';
// ===== Constants =====
 ...
 */
function validateAndNormalizePack(packName, data) {
    try {
 ...
 */
function loadEmbeddedPack(packName, packData, stats) {
    try {
        // Validate and normalize pack structure
...
export function loadKnowledgeBase() {
    ...
    if (EMBEDDED_PACKS.length === 0) {
        const error = new Error(`No knowledge packs embedded - server cannot start without knowledge base.\n` +
            `\n` +
