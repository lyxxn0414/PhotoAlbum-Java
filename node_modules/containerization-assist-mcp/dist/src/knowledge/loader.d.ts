 ...
 */
import type { LoadedEntry } from './types.js';
/**
 ...
 */
export declare function discoverBuiltInKnowledgePacks(): string[];
/**
 * Load knowledge entries from built-in knowledge packs
 * Throws an error if any built-in pack fails to load
 */
export declare function loadKnowledgeBase(): void;
/**
 * Get all loaded knowledge entries
 */
export declare function getAllEntries(): LoadedEntry[];
/**
 ...
 */
export declare function loadKnowledgeData(): {
    entries: LoadedEntry[];
};
