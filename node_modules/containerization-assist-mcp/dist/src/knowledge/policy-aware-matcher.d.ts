 ...
 */
import type { RegoEvaluator } from '../config/policy-rego.js';
import type { KnowledgeQuery, KnowledgeMatch, LoadedEntry } from './types.js';
import type { FilteredKnowledgeResult } from './policy-types.js';
/**
 ...
 */
export declare function findPolicyAwareKnowledgeMatches(entries: LoadedEntry[], query: KnowledgeQuery, policy?: RegoEvaluator): Promise<{
 ...
 */
export declare function getPolicyAwareKnowledgeSnippets(entries: LoadedEntry[], query: KnowledgeQuery, policy?: RegoEvaluator): Promise<{
    snippets: Array<{
        id: string;
        text: string;
        weight: number;
