 ...
 */
import type { RegoEvaluator, RegoPolicyResult } from './policy-rego.js';
/**
 ...
 * ```
 */
export declare function applyPolicy(evaluator: RegoEvaluator, input: string | Record<string, unknown>): Promise<RegoPolicyResult>;
//# sourceMappingURL=policy-eval.d.ts.map