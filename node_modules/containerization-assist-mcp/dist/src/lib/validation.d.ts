 ...
 * ```
 */
export declare function validatePath(pathStr: string, options?: PathValidationOptions): Promise<Result<string>>;
/**
 ...
 * ```
 */
export declare function validateImageName(imageName: string): Result<string>;
/**
 ...
 * ```
 */
export declare function validateK8sName(name: string): Result<string>;
/**
 ...
 * ```
 */
export declare function validateEnvName(name: string): Result<string>;
/**
 ...
 * ```
 */
export declare function validatePort(port: number): Result<number>;
/**
 ...
 * ```
 */
export declare function validateNamespace(namespace: string): Result<string>;
/**
 * Validate Docker tag
 *
 ...
 * ```
 */
export declare function validateDockerTag(tag: string): Result<string>;
