 ...
 * parseCPU("2")     // 2000
 */
export declare function parseCPU(cpu: string): Result<number>;
/**
 ...
 */
export declare function parseMemory(memory: string): Result<number>;
/**
 ...
 * // "node:18-alpine"
 */
export declare function extractImageName(dockerfile: string): Result<string>;
/**
 ...
 * // [3000, 8080]
 */
export declare function extractPorts(dockerfile: string): Result<number[]>;
/**
 ...
 */
export declare function calculateResourceRatio(limit: number, request: number): Result<number>;
/**
 ...
 * // ["myapp:v1"]
 */
export declare function extractManifestImages(manifest: unknown): Result<string[]>;
/**
 ...
 * // [3000]
 */
export declare function extractServicePorts(service: unknown): Result<number[]>;
//# sourceMappingURL=policy-parsers.d.ts.map