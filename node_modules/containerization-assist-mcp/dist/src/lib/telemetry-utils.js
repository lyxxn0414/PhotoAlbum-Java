 ...
 */
export function sanitizeToolInput(params) {
    const sanitized = {};
 ...
 */
export function extractSafeTelemetryMetrics(toolName, result) {
    const metrics = {};
 ...
 */
export function createSafeTelemetryEvent(toolName, params, result, durationMs) {
    const event = {
        toolName,
        success: result.ok,
