 ...
 */
export function getToolLogger(context, toolName) {
 ...
 */
export function createToolTimer(logger, toolName) {
 ...
 * ```
 */
export function createStandardizedToolTracker(toolName, params, logger) {
