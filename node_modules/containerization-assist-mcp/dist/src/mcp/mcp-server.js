...
import { formatScanImageNarrative, formatDockerfilePlanNarrative, formatBuildImageNarrative, formatAnalyzeRepoNarrative, formatVerifyDeployNarrative, formatFixDockerfileNarrative, formatGenerateK8sManifestsNarrative, formatPushImageNarrative, formatTagImageNarrative, formatPrepareClusterNarrative, formatOpsPingNarrative, formatOpsStatusNarrative, } from './formatters/natural-language-formatters.js';
/**
 * Constants
 */
const RESOURCE_URI = {
 ...
 */
export function createMCPServer(tools, options = {}, execute) {
 ...
 */
export function registerToolsWithServer(options) {
 ...
 */
export function formatOutput(output, format, chainHintsMode = CHAINHINTSMODE.ENABLED) {
    switch (format) {
 ...
 */
function formatAsNaturalLanguage(output, chainHintsMode = CHAINHINTSMODE.ENABLED) {
