 ...
 */
import { formatDuration, formatVulnerabilities, pluralize } from '../../lib/summary-helpers.js';
 ...
 */
export function formatScanImageNarrative(result, chainHintsMode = CHAINHINTSMODE.ENABLED) {
    const parts = [];
    // Header
 ...
 */
export function formatDockerfilePlanNarrative(plan, chainHintsMode = CHAINHINTSMODE.ENABLED) {
    const parts = [];
 ...
 */
export function formatBuildImageNarrative(result, chainHintsMode = CHAINHINTSMODE.ENABLED) {
    const parts = [];
    // Header
 ...
 */
export function formatAnalyzeRepoNarrative(result, chainHintsMode = CHAINHINTSMODE.ENABLED) {
    const parts = [];
    // Header
 ...
 */
export function formatVerifyDeployNarrative(result, chainHintsMode = CHAINHINTSMODE.ENABLED) {
    const parts = [];
    // Header
 ...
 */
export function formatFixDockerfileNarrative(result, chainHintsMode = CHAINHINTSMODE.ENABLED) {
    const parts = [];
 ...
 */
export function formatGenerateK8sManifestsNarrative(result, chainHintsMode = CHAINHINTSMODE.ENABLED) {
    const parts = [];
    // Action-oriented header
 ...
 */
export function formatPushImageNarrative(result, chainHintsMode = CHAINHINTSMODE.ENABLED) {
    const parts = [];
    // Header
 ...
 */
export function formatTagImageNarrative(result, chainHintsMode = CHAINHINTSMODE.ENABLED) {
    const parts = [];
    // Header
 ...
 * - Context-aware next steps (when chainHintsMode is 'enabled')
 */
export function formatPrepareClusterNarrative(result, chainHintsMode = CHAINHINTSMODE.ENABLED) {
    const parts = [];
    // Header
 ...
 */
export function formatOpsPingNarrative(result) {
    const parts = [];
    // Header
 ...
 */
export function formatOpsStatusNarrative(result) {
    const parts = [];
    // Header
    const icon = result.success ? '💚' : '❌';
