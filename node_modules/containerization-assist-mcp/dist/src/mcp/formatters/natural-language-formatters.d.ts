 ...
 */
import type { ScanImageResult } from '../../tools/scan-image/tool.js';
import type { DockerfilePlan } from '../../tools/generate-dockerfile/schema.js';
import type { BuildImageResult } from '../../tools/build-image/tool.js';
import type { RepositoryAnalysis } from '../../tools/analyze-repo/schema.js';
import type { VerifyDeploymentResult } from '../../tools/verify-deploy/tool.js';
import type { DockerfileFixPlan } from '../../tools/fix-dockerfile/schema.js';
import type { ManifestPlan } from '../../tools/generate-k8s-manifests/schema.js';
import type { PushImageResult } from '../../tools/push-image/tool.js';
import type { TagImageResult } from '../../tools/tag-image/tool.js';
import type { PrepareClusterResult } from '../../tools/prepare-cluster/tool.js';
import type { PingResult, ServerStatusResult } from '../../tools/ops/tool.js';
import { ChainHintsMode } from '../../app/orchestrator-types.js';
/**
 ...
 */
export declare function formatScanImageNarrative(result: ScanImageResult, chainHintsMode?: ChainHintsMode): string;
/**
 ...
 */
export declare function formatDockerfilePlanNarrative(plan: DockerfilePlan, chainHintsMode?: ChainHintsMode): string;
/**
 ...
 */
export declare function formatBuildImageNarrative(result: BuildImageResult, chainHintsMode?: ChainHintsMode): string;
/**
 ...
 */
export declare function formatAnalyzeRepoNarrative(result: RepositoryAnalysis, chainHintsMode?: ChainHintsMode): string;
/**
 ...
 */
export declare function formatVerifyDeployNarrative(result: VerifyDeploymentResult, chainHintsMode?: ChainHintsMode): string;
/**
 ...
 */
export declare function formatFixDockerfileNarrative(result: DockerfileFixPlan, chainHintsMode?: ChainHintsMode): string;
/**
 ...
 */
export declare function formatGenerateK8sManifestsNarrative(result: ManifestPlan, chainHintsMode?: ChainHintsMode): string;
/**
 ...
 */
export declare function formatPushImageNarrative(result: PushImageResult, chainHintsMode?: ChainHintsMode): string;
/**
 ...
 */
export declare function formatTagImageNarrative(result: TagImageResult, chainHintsMode?: ChainHintsMode): string;
/**
 ...
 * - Context-aware next steps (when chainHintsMode is 'enabled')
 */
export declare function formatPrepareClusterNarrative(result: PrepareClusterResult, chainHintsMode?: ChainHintsMode): string;
/**
 ...
 */
export declare function formatOpsPingNarrative(result: PingResult): string;
/**
 ...
 */
export declare function formatOpsStatusNarrative(result: ServerStatusResult): string;
//# sourceMappingURL=natural-language-formatters.d.ts.map