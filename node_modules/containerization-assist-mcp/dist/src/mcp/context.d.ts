...
import { createToolContext as createCoreContext, type ToolContext, type ProgressReporter, type ContextOptions as CoreContextOptions } from '../core/context.js';
 ...
 * ```
 */
export declare function createToolContext(logger: Logger, options?: ContextOptions): ToolContext;
