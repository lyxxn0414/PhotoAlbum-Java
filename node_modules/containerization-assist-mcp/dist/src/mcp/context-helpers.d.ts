 ...
 */
export type EnhancedProgressReporter = (message: string, progress?: number, total?: number, metadata?: Record<string, unknown>) => Promise<void>;
/**
 ...
 */
export declare function extractProgressToken(request: unknown): string | undefined;
/**
 * Creates a progress reporter that forwards notifications through the MCP protocol
 */
export declare function createProgressReporter(progressToken?: string | number, logger?: Logger, sendNotification?: (notification: unknown) => Promise<void>): EnhancedProgressReporter | undefined;
/**
 * Extract progress reporter from various input types
 */
export declare function extractProgressReporter(progress: unknown, logger: Logger, sendNotification?: (notification: unknown) => Promise<void>): EnhancedProgressReporter | undefined;
