...
export function generateDockerfileStep() {
    return {
...
export function deployStep(target) {
    return {
...
export function verifyStep(extraLines) {
    const lines = [
 ...
 */
export function assemblePrompt(title, contextLines, steps, rules) {
