 ...
 */
export function applyFixes(content, ruleIds) {
    try {
 ...
 */
export function applyAllFixes(content) {
 ...
 */
function reconstructDockerfile(commands) {
    const lines = [];
 ...
 */
export function hasFixForRule(ruleId) {
...
//# sourceMappingURL=dockerfile-fixer.js.map