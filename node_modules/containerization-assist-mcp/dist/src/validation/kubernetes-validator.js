...
const KUBERNETES_RULES = [
    ...
    },
    {
        ...
        check: (manifest) => {
            ...
            return !volumes.some((volume) => volume.hostPath);
        },
 ...
 */
const parseDocuments = (yamlContent) => {
 ...
 */
const validateKubernetesContent = (yamlContent) => {
    try {
        try {
 ...
 */
//# sourceMappingURL=kubernetes-validator.js.map