 ...
 */
import { KubernetesValidationRule, ValidationReport, ValidationCategory } from './core-types.js';
 ...
 */
export declare const createKubernetesValidator: () => KubernetesValidatorInstance;
/**
 * Standalone validation function for simple use cases
 */
//# sourceMappingURL=kubernetes-validator.d.ts.map