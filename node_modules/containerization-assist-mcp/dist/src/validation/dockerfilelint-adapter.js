 ...
 */
export async function lintWithDockerfilelint(dockerfileContent) {
    ...
    try {
        ...
        fs.closeSync(fd);
        try {
            const cli = spawnSync(process.platform === 'win32' ? 'npx.cmd' : 'npx', ['-y', 'dockerfilelint', '--json', tmpFile], { encoding: 'utf8' });
            // Clean up temp file
            try {
