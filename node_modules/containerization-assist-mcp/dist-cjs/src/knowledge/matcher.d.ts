 ...
 */
export declare const findKnowledgeMatches: (entries: LoadedEntry[], query: KnowledgeQuery) => KnowledgeMatch[];
/**
 ...
 */
export declare function getKnowledgeSnippets(topic: Topic, options: KnowledgeSnippetOptions): Promise<KnowledgeSnippet[]>;
