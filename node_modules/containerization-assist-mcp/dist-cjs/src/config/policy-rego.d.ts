...
export interface RegoEvaluator {
     ...
     */
    evaluatePolicy<T>(result: Result<T>, packageName?: string): Promise<Result<CategorizedViolations>>;
    /**
 ...
 * ```
 */
export declare function loadRegoPolicy(policyPath: string, logger: Logger): Promise<Result<RegoEvaluator>>;
/**
 ...
 * @returns Result containing RegoEvaluator or error
 */
export declare function loadAndMergeRegoPolicies(policyPaths: string[], logger: Logger): Promise<Result<RegoEvaluator>>;
/**
 ...
 */
export declare function loadPolicies(options: {
    policiesPath: string;
    filePattern?: string;
}, logger?: Logger): Promise<Result<RegoPolicy>>;
/**
 * Convenience type alias for RegoEvaluator used in tests
 */
export type RegoPolicy = RegoEvaluator;
//# sourceMappingURL=policy-rego.d.ts.map