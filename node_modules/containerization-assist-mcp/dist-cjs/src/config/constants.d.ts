...
export declare const ENV_VARS: {
    ...
    readonly CUSTOM_POLICY_PATH: "CUSTOM_POLICY_PATH";
};
/**
 * Environment Schema
 * Zod schema for environment validation across the application.
 */
export declare const environmentSchema: z.ZodEnum<["development", "staging", "production", "testing"]>;
export type Environment = z.infer<typeof environmentSchema>;
/**
 * Default ports by programming language/framework
 */
export declare const DEFAULT_PORTS: {
    readonly javascript: readonly [3000, 8080];
    readonly typescript: readonly [3000, 8080];
    readonly python: readonly [8000, 5000];
    readonly java: readonly [8080, 8081];
    readonly go: readonly [8080, 3000];
    readonly rust: readonly [8080, 3000];
    readonly ruby: readonly [3000, 9292];
    readonly php: readonly [8080, 80];
    readonly csharp: readonly [8080, 5000];
    readonly dotnet: readonly [8080, 5000];
    readonly default: readonly [3000, 8080];
};
/**
...
export declare const DEFAULT_TIMEOUTS: {
    ...
    readonly trivyVersionCheck: 15000;
    /** Cluster stabilization wait: 5 seconds. */
    readonly clusterStabilization: 5000;
};
/**
...
export declare const DOCKER: {
    ...
    readonly REGISTRY_PORT: 6000;
    /** Registry port search range start */
    readonly REGISTRY_PORT_START: 6000;
    /** Registry port search range end */
    readonly REGISTRY_PORT_END: 6100;
    /** Registry container name */
    readonly REGISTRY_CONTAINER_NAME: "ca-registry";
    /** Registry host for external access */
    readonly REGISTRY_HOST: "localhost";
    /** Registry internal port (inside container) */
    readonly REGISTRY_INTERNAL_PORT: 5000;
};
/**
 * Kubernetes constants
 */
export declare const KUBERNETES: {
    /** Default namespace */
    readonly DEFAULT_NAMESPACE: "default";
    /** Deployment check interval (ms) */
    readonly DEPLOYMENT_CHECK_INTERVAL: 5000;
    /** Max deployment checks */
    readonly MAX_DEPLOYMENT_CHECKS: 60;
    ...
    /** Default cluster */
    readonly DEFAULT_CLUSTER: "default";
    /** Default HTTP port */
    readonly DEFAULT_HTTP_PORT: 80;
    /** Default HTTPS port */
    readonly DEFAULT_HTTPS_PORT: 443;
    /** Pending LoadBalancer URL placeholder */
    readonly PENDING_LB_URL: "http://pending-loadbalancer";
    /** Default ingress host */
    readonly DEFAULT_INGRESS_HOST: "app.example.com";
};
/**
...
export declare const FRAMEWORK_PORTS: {
    readonly next: 3000;
    readonly react: 3000;
    readonly angular: 4200;
    readonly nuxt: 3000;
    readonly vue: 3000;
    readonly django: 8000;
    readonly flask: 5000;
    readonly fastapi: 8000;
    readonly 'aspnet-core': 5000;
    readonly 'aspnet-core-https': 5001;
};
/**
 * Get default port for a given language
 */
export declare function getDefaultPort(language: string): number;
/**
 * Get default port for a given framework
 */
export declare function getFrameworkPort(framework: string): number | undefined;
