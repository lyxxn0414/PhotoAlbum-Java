...
exports.FRAMEWORK_PORTS = exports.KUBERNETES = exports.DOCKER = exports.RETRY = exports.LIMITS = exports.DEFAULT_NETWORK = exports.DEFAULT_TIMEOUTS = exports.DEFAULT_PORTS = exports.environmentSchema = exports.ENV_VARS = void 0;
exports.getDefaultPort = getDefaultPort;
exports.getFrameworkPort = getFrameworkPort;
...
function getDefaultPort(language) {
    ...
    const ports = exports.DEFAULT_PORTS[key] || exports.DEFAULT_PORTS.default;
    return ports[0];
}
/**
...
function getFrameworkPort(framework) {
    ...
    return exports.FRAMEWORK_PORTS[key];
}
