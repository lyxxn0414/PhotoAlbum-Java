...
exports.validatePathOrFail = validatePathOrFail;
exports.validateImageTag = validateImageTag;
...
function parseImageName(imageName) {
    ...
    let repository;
    if (parts.length === 0) {
        return (0, types_1.Failure)('Invalid image name: repository is required', {
    ...
    const tagValidation = (0, validation_1.validateDockerTag)(tag);
    if (!tagValidation.ok) {
 ...
 * ```
 */
async function validatePathOrFail(pathInput, options = {}) {
    return (0, validation_1.validatePath)(pathInput, options);
}
/**
...
function validateImageTag(tag) {
    return (0, validation_1.validateDockerTag)(tag);
}
/**
...
function createPathValidator(options) {
    return async (path) => {
        return (0, validation_1.validatePath)(path, options);
    };
}
