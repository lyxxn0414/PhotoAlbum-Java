...
import { type PathValidationOptions } from './validation';
/**
 ...
 * ```
 */
export declare function parseImageName(imageName: string): Result<ParsedImageName>;
/**
 ...
 * ```
 */
export declare function validatePathOrFail(pathInput: string, options?: PathValidationOptions): Promise<Result<string>>;
/**
 ...
 * ```
 */
export declare function validateImageTag(tag: string): Result<string>;
/**
 ...
 * ```
 */
export declare function createPathValidator(options: PathValidationOptions): (path: string) => Promise<Result<string>>;
