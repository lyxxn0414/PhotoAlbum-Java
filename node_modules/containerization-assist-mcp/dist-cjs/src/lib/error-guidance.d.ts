 ...
 * ```
 */
export declare function createErrorGuidanceBuilder(patterns: ErrorPattern[], defaultGuidance?: (error: unknown) => ErrorGuidance): (error: unknown) => ErrorGuidance;
/**
 ...
 * ```
 */
export declare function messagePattern(substring: string, guidance: ErrorGuidance): ErrorPattern;
/**
 ...
 * ```
 */
export declare function customPattern(matchFn: (error: unknown) => boolean, guidance: ErrorGuidance | ((error: unknown) => ErrorGuidance)): ErrorPattern;
