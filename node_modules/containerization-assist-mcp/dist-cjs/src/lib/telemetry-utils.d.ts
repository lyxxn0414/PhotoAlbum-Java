 ...
 */
export declare function sanitizeToolInput(params: Record<string, unknown>): Record<string, unknown>;
/**
 * Extract safe telemetry metrics from tool results
 * Returns only aggregate metrics, no sensitive data
 */
export declare function extractSafeTelemetryMetrics(toolName: ToolName, result: Record<string, unknown>): Record<string, unknown>;
/**
 ...
 */
export declare function createSafeTelemetryEvent(toolName: ToolName, params: Record<string, unknown>, result: {
    ok: boolean;
    value?: Record<string, unknown>;
    error?: string;
}, durationMs?: number): SafeTelemetryEvent;
