 ...
 */
export declare function getDownloadOS(): string;
/**
 * Get architecture string for download URLs
 */
export declare function getDownloadArch(): string;
/**
 * Map Kubernetes node architecture to Docker platform format
 */
export declare function mapNodeArchToPlatform(arch: string, os?: string): DockerPlatform | null;
/**
 ...
 */
export declare function isPlatformCompatible(targetPlatform: DockerPlatform, clusterPlatform: DockerPlatform): boolean;
/**
...
export declare function normalizePath(inputPath: string | null | undefined): string | null | undefined;
