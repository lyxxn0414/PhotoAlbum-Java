...
exports.LOG_FORMAT = void 0;
exports.logStartup = logStartup;
exports.logStartupSuccess = logStartupSuccess;
exports.logStartupFailure = logStartupFailure;
exports.logShutdownStart = logShutdownStart;
exports.logShutdownSuccess = logShutdownSuccess;
exports.logShutdownFailure = logShutdownFailure;
exports.logForcedShutdown = logForcedShutdown;
exports.createShutdownHandler = createShutdownHandler;
exports.installShutdownHandlers = installShutdownHandlers;
exports.logToolStart = logToolStart;
exports.logToolComplete = logToolComplete;
exports.logToolFailure = logToolFailure;
/**
 * Log startup messages in a consistent format
 */
function logStartup(info, logger, quiet = false) {
    logger.info({
 ...
 */
function logStartupSuccess(transport, logger, quiet = false) {
 ...
 * Log startup failure
 */
function logStartupFailure(error, logger, quiet = false) {
 ...
 * @public
 */
function logShutdownStart(signal, logger, quiet = false) {
 ...
 * @public
 */
function logShutdownSuccess(info, logger, quiet = false) {
    logger.info({
        signal: info.signal,
 ...
 * @public
 */
function logShutdownFailure(error, info, logger, quiet = false) {
    logger.error({
        error,
        signal: info.signal,
        duration: info.duration,
 ...
 * @public
 */
function logForcedShutdown(logger, quiet = false) {
 ...
 * @public
 */
function createShutdownHandler(server, logger, quiet = false, timeoutMs = 10000) {
    return async (signal) => {
 ...
 */
function installShutdownHandlers(server, logger, quiet = false) {
 ...
 * ```
 */
function logToolStart(toolName, params, logger) {
 ...
 * ```
 */
function logToolComplete(toolName, result, logger, durationMs) {
 ...
 * ```
 */
function logToolFailure(toolName, error, logger, context) {
