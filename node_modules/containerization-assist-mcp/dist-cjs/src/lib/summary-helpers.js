...
exports.buildDetailedSummary = buildDetailedSummary;
exports.truncate = truncate;
exports.formatVulnerabilities = formatVulnerabilities;
 ...
 * // "❌ Tests failed"
 */
function buildStatusSummary(success, successMessage, failureMessage) {
    const icon = success ? '✅' : '❌';
 ...
 * //   → Monitor logs"
 */
function buildDetailedSummary(heading, details, nextSteps) {
    const parts = [heading];
    if (details.length > 0) {
...
//# sourceMappingURL=summary-helpers.js.map