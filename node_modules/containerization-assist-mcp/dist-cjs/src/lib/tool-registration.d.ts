...
import type { AppRuntime, ToolInputMap, ToolResultMap } from '../types/runtime';
import type { Tool } from '../types/tool';
import type { ToolName } from '../tools';
import { type OutputFormat } from '../mcp/mcp-server';
 ...
 * ```
 */
export declare function createToolHandler<TName extends ToolName>(app: AppRuntime, toolName: TName, options?: ToolHandlerOptions<TName>): (rawParams: Record<string, unknown> | undefined, extra: RequestHandlerExtra<ServerRequest, ServerNotification>) => Promise<{
    content: {
        type: "text";
        text: string;
    }[];
 ...
 * ```
 */
export declare function registerTool(server: McpServer, app: AppRuntime, tool: Tool, options?: ToolHandlerOptions): void;
/**
 ...
 * ```
 */
export declare function registerTools(server: McpServer, app: AppRuntime, tools: readonly Tool[], options?: ToolHandlerOptions): void;
