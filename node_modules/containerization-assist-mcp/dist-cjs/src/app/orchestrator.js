...
function createContextForTool(request, logger, policy) {
    ...
    if (metadata?.signal)
        contextOptions.signal = metadata.signal;
    ...
    if (metadata?.sendNotification)
        contextOptions.sendNotification = metadata.sendNotification;
    if (policy)
        contextOptions.policy = policy;
    return (0, context_1.createToolContext)(logger, contextOptions);
}
/**
