 ...
 */
function wrapProgressCallback(onProgress) {
    if (!onProgress)
        return undefined;
...
async function executeTool(tool, input, options = {}) {
    ...
    if (options.signal !== undefined)
        ctxOptions.signal = options.signal;
    if (progressReporter !== undefined)
        ctxOptions.progress = progressReporter;
    const ctx = (0, context_1.createToolContext)(logger, ctxOptions);
    ...
    if (!parseResult.success) {
        const issues = parseResult.error.issues
            ...
            .join('; ');
        return (0, core_1.Failure)(`Validation failed: ${issues}`, {
