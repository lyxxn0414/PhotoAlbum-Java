 ...
 * ```
 */
export declare function createAbortSignalFromToken(token: CancellationTokenLike): AbortSignalResult;
/**
 ...
 * ```
 */
export declare function formatErrorForLLM(error: string, guidance?: ErrorGuidance): string;
/**
 ...
 * ```
 */
export declare function resolveWorkspacePath(inputPath: string, workspaceRoot: string): string;
/**
 ...
 * ```
 */
export declare function validateRequiredFields<const T extends string>(input: Record<string, unknown>, requiredFields: readonly T[]): ValidationResult<T>;
/**
 ...
 */
export declare function sanitizeForMarkdown(input: string): string;
//# sourceMappingURL=vscode-utils.d.ts.map