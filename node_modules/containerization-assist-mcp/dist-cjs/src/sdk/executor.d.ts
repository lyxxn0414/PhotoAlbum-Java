 ...
 * ```
 */
export declare function executeTool<TSchema extends ZodTypeAny, TOutput>(tool: Tool<TSchema, TOutput>, input: unknown, options?: SDKOptions): Promise<Result<TOutput>>;
