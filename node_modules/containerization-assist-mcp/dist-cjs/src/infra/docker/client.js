        ...
        async ping() {
            try {
                ...
                return (0, types_1.Failure)(errorMessage, {
                    ...
                    resolution: 'Ensure Docker is installed and running. On Windows, check Docker Desktop is started. On Mac, ensure Docker Desktop or Colima is running.',
...
const createDockerClient = (logger, config) => {
    ...
    if (socketPath.startsWith('tcp://') ||
        ...
        if (config?.host) {
            ...
            try {
                const parsed = (0, socket_validation_1.parseDockerHost)(socketPath);
                if (parsed.type === 'tcp') {
