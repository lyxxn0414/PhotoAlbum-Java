 ...
 */
export declare function getImageMetadata(imageName: string, tag: string, logger: Logger): Promise<ImageMetadata>;
/**
 ...
 */
export declare function authenticateRegistry(docker: Docker, config: RegistryConfig, logger: Logger): Promise<Result<{
    username: string;
    password: string;
 ...
 */
export declare function checkRegistryHealth(registryUrl: string, logger: Logger): Promise<Result<boolean>>;
/**
 ...
 */
export declare function checkImageExists(docker: Docker, imageName: string, logger: Logger): Promise<Result<boolean>>;
/**
 ...
 */
export declare function listRepositoryTags(repository: string, logger: Logger, authConfig?: {
    username: string;
    password: string;
    serveraddress: string;
