...
exports.autoDetectDockerSocket = autoDetectDockerSocket;
exports.validateDockerSocket = validateDockerSocket;
 ...
 */
function getColimaSockets() {
    const homeDir = (0, os_1.homedir)();
    return [
        (0, path_1.join)(homeDir, '.colima/default/docker.sock'),
        (0, path_1.join)(homeDir, '.colima/docker/docker.sock'),
        (0, path_1.join)(homeDir, '.lima/colima/sock/docker.sock'), // Lima-based colima
    ];
}
/**
 * Find the first available Docker socket from the given paths (synchronous file-based check).
 */
function findAvailableDockerSocket(socketPaths) {
    for (const socketPath of socketPaths) {
        try {
            if ((0, fs_1.existsSync)(socketPath)) {
                const stat = (0, fs_1.statSync)(socketPath);
                if (stat.isSocket()) {
                    return socketPath;
                }
            }
 ...
 */
function autoDetectDockerSocket() {
 ...
 */
function shouldLogOutput(quiet) {
 ...
 */
function validateDockerSocket(options, quiet = false) {
    const warnings = [];
    let dockerSocket = '';
    ...
    try {
        ...
        const stat = (0, fs_1.statSync)(dockerSocket);
        if (!stat.isSocket()) {
        ...
        const errorMsg = (0, errors_1.extractErrorMessage)(error);
