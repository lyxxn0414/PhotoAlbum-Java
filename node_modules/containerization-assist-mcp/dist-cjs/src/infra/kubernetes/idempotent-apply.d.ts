 ...
 */
export declare function createIdempotentApply(logger: Logger, kubeconfig?: string): (resource: K8sResource, options?: ApplyOptions) => Promise<Result<K8sResource>>;
/**
 * Parse YAML manifests into K8s resources
 */
export declare function parseManifests(yamlContent: string): K8sResource[];
//# sourceMappingURL=idempotent-apply.d.ts.map