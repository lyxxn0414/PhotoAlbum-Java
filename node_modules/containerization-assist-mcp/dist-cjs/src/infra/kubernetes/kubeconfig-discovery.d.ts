 ...
 */
export declare function discoverKubeconfigPath(): Result<string>;
/**
 * Validate that a kubeconfig file is readable and parseable
 */
export declare function validateKubeconfig(configPath: string): Result<KubeconfigInfo>;
/**
 * Discover and validate kubeconfig in one step
 */
export declare function discoverAndValidateKubeconfig(): Result<KubeconfigInfo>;
/**
...
//# sourceMappingURL=kubeconfig-discovery.d.ts.map