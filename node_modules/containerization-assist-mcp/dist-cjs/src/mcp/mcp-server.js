 ...
 */
function createLoggerContext(toolName, transport, meta) {
    return {
        transport,
        tool: toolName,
 ...
 */
function createExecuteMetadata(toolName, params, transport, extra) {
