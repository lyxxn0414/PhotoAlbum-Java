...
exports.buildAksRemoteDevLoopPrompt = buildAksRemoteDevLoopPrompt;
const tools_1 = require("../../tools");
const steps_1 = require("../shared/steps");
function buildAksRemoteDevLoopPrompt(args) {
    ...
    return (0, steps_1.assemblePrompt)('AKS remote cluster deployment iteration loop', [
        ...
        (0, steps_1.generateDockerfileStep)(),
        {
            ...
            body: [
                `1. Call **${tools_1.TOOL_NAME.BUILD_IMAGE_CONTEXT}** with the repository path, image name, and platform \`linux/amd64\`.`,
        ...
        },
        {
            ...
            body: [
                `1. Call **${tools_1.TOOL_NAME.TAG_IMAGE}** to tag the image for the Azure Container Registry: \`${registry}/<image>:<tag>\`.`,
                '2. Retry up to **2 times** on failure.',
            ].join('\n'),
        },
        {
            ...
            body: [
                `1. Call **${tools_1.TOOL_NAME.PUSH_IMAGE}** to push the tagged image to \`${registry}\`.`,
                '2. Retry up to **2 times** on failure.',
        ...
        },
        {
            ...
            body: [
                ...
                `1. Call **${tools_1.TOOL_NAME.GENERATE_K8S_MANIFESTS}** with the repository path, namespace, and analysis context. Set the image reference in the manifests to use the ACR registry prefix \`${registry}/\`.`,
                "2. Follow the tool's guidance to create manifest files on disk.",
                '3. Retry up to **2 times** if generation fails.',
            ].join('\n'),
        },
        (0, steps_1.deployStep)('AKS'),
